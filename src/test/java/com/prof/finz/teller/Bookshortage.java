...
public class Bookshortage extends Utility{
...
public static final Logger log = Logger.getLogger(BillPaymentByCash.class.getName());
	...
	public void UpdatingData() throws Exception {
		...
		for (Map<String, String> data : pram) {
			...
			if(data.get("Action").equalsIgnoreCase("Bookshortage")) {

				driver.findElement(By.xpath("//div[contains(text(),'Book shortage')]")).click();
				log.info("Clicked on Book shortage");
